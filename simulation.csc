...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype937</identifier>
      <description>Server</description>
      <source>[CONTIKI_DIR]/examples/IoTickMote/server.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/IoTickMote/client.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>50.46254507263781</x>
        <y>34.14247350078095</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype937</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.45815014321562</x>
        <y>70.96557431111641</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.0830170044519076 0.0 0.0 2.0830170044519076 26.235758730039493 -8.304258781796582</viewport>
    </plugin_config>
    <width>287</width>
    <z>1</z>
    <height>221</height>
